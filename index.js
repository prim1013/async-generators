...
module.exports = {
    run: function ( id, promises ) {
        ...
        var promisesGenerator = function * ( id ) {
            var results = [];

            // for some reason .forEach does not work here
            for ( var i = 0; i < promises.length; i++ ) {
                results.push( yield(promises[i]( id )) );
            }
        ...
        var workflowProxy = createPromiseWorkflow( promisesGenerator );
